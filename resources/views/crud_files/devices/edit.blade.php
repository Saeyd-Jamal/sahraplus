<div class="container">
    ...
    <form action="{{ route('devices.update', $device->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="user_id" value="{{old("user_id", $device["user_id"])}}">
            @error("user_id")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="active_profile" value="{{old("active_profile", $device["active_profile"])}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="platform" value="{{old("platform", $device["platform"])}}">
            @error("platform")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="deleted_at" value="{{old("deleted_at", $device["deleted_at"])}}">
            @error("deleted_at")
                <p>{{$message}}</p>
            @enderror
        </div>
