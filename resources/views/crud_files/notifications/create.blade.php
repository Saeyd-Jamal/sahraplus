...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="notifiable_type" value="{{old("notifiable_type")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="notifiable_id" value="{{old("notifiable_id")}}">
            @error("notifiable_id")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="read_at" value="{{old("read_at")}}">
            @error("read_at")
                <p>{{$message}}</p>
            @enderror
        </div>
