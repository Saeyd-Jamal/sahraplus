<div class="container">
    <h2>Create entertainment_talent_mappings</h2>
    <form action="{{ route('entertainment_talent_mappings.store') }}" method="POST">
        @csrf
        <div class="mb-3">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="talent_id" value="{{old("talent_id")}}">
            @error("talent_id")
                <p>{{$message}}</p>
            @enderror
        </div>
