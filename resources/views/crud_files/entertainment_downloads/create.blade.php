<div class="container">
    <h2>Create entertainment_downloads</h2>
    <form action="{{ route('entertainment_downloads.store') }}" method="POST">
        @csrf
        <div class="mb-3">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="is_download" value="{{old("is_download")}}">
            @error("is_download")
                <p>{{$message}}</p>
            @enderror
        </div>
