...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="season_id" value="{{old("season_id")}}">
            @error("season_id")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="tmdb_season" value="{{old("tmdb_season")}}">
            @error("tmdb_season")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="episode_number" value="{{old("episode_number")}}">
