...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="tmdb_id" value="{{old("tmdb_id")}}">
            @error("tmdb_id")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="thumbnail_url" value="{{old("thumbnail_url")}}">
            @error("thumbnail_url")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="entlogo" value="{{old("entlogo")}}">
            @error("entlogo")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="numberedimage" value="{{old("numberedimage")}}">
            @error("numberedimage")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="trailer_url_type" value="{{old("trailer_url_type")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="trailer_url" value="{{old("trailer_url")}}">
            @error("trailer_url")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="movie_access" value="{{old("movie_access")}}">
            @error("movie_access")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="content_rating" value="{{old("content_rating")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="video_upload_type" value="{{old("video_upload_type")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="video_url_input" value="{{old("video_url_input")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="video_quality_url" value="{{old("video_quality_url")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="enable_quality" value="{{old("enable_quality")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="download_status" value="{{old("download_status")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="download_type" value="{{old("download_type")}}">
            @error("download_type")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="enable_download_quality" value="{{old("enable_download_quality")}}">
