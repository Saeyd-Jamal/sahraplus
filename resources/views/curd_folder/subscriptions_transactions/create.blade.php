<div class="container">
    <h2>Create subscriptions_transactions</h2>
    <form action="{{ route('subscriptions_transactions.store') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label for="subscriptions_id" class="form-label">subscriptions_id</label>
            <input type="text" class="form-control" name="subscriptions_id" value="{{old("subscriptions_id")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="tax_data" value="{{old("tax_data")}}">
            @error("tax_data")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="other_transactions_details" value="{{old("other_transactions_details")}}">
