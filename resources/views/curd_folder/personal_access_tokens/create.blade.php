<div class="container">
    <h2>Create personal_access_tokens</h2>
    <form action="{{ route('personal_access_tokens.store') }}" method="POST">
        @csrf
        <div class="mb-3">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="abilities" value="{{old("abilities")}}">
            @error("abilities")
                <p>{{$message}}</p>
            @enderror
        </div>
