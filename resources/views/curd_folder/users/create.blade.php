...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="login_type" value="{{old("login_type")}}">
            @error("login_type")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="is_banned" value="{{old("is_banned")}}">
            @error("is_banned")
                <p>{{$message}}</p>
            @enderror
        </div>
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="is_subscribe" value="{{old("is_subscribe")}}">
            @error("is_subscribe")
                <p>{{$message}}</p>
            @enderror
        </div>
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="last_notification_seen" value="{{old("last_notification_seen")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="is_parental_lock_enable" value="{{old("is_parental_lock_enable")}}">
...
<div class="mb-3">
            ...
            <input type="text" class="form-control" name="father_code" value="{{old("father_code")}}">
            @error("father_code")
                <p>{{$message}}</p>
            @enderror
        </div>
