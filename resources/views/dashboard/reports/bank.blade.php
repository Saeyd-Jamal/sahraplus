        ...
        <div style="padding: 5px 0">
            @if(!isset($filter["association"][1]) && isset($filter["association"][0]))
                @if ($filter['association'][0] == 'المدينة')
                    <img src="{{ public_path('imgs/headers/city_architecture.jpg') }}" style="max-width: 100%;"
                        alt="">
                ...
                @elseif ($filter['association'][0] == 'الكويتي')
                    <img src="{{ public_path('imgs/headers/Kuwaiti.jpg') }}" style="max-width: 100%;"
                        alt="">
                @elseif ($filter['association'][0] == 'يتيم')
                    <img src="{{ public_path('imgs/headers/orphan.jpg') }}" style="max-width: 100%;"
                        alt="">
